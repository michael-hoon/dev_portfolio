...
<div class="image-row">
    <Figure 
      src={Architecture} 
      alt="GraphMind Proposed Architecture" 
      caption="Figure 1: GraphMind Proposed Architecture"
      width="80%"
    />
    <Figure 
      src={Router} 
      alt="Semantic Router Agent" 
      caption="Figure 2: Semantic Router Agent"
      width="80%"
    />
    <Figure 
      src={ResearchSubgraph} 
      alt="Research Subgraph" 
      caption="Figure 3: Research Subgraph"
      width="80%"
    />
    <Figure 
      src={AgentNodes} 
      alt="Agent Node Architecture" 
      caption="Figure 4: Multi Agent Node Architecture"
      width="80%"
    />
</div>
...
<div class="image-center">
    <Figure 
      src={Neo4jOntology} 
      alt="Neo4j Ontology" 
      caption="Figure 5: Neo4j Database Ontology"
      width="80%"
    />
</div>
