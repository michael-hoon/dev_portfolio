...
import homelabexample from '../assets/homelab/homelab_example.jpeg';
...
import diagram4 from '../assets/homelab/diagram_4.png';
...
<Figure 
  src={homelabexample} 
  alt="Diagram: Example of a homelab setup" 
  caption="Example of a homelab setup."
/>
...
<Figure 
  src={diagram4} 
  alt="Diagram: downloads and the media library sit under one mounted filesystem, mapped identically across every container, so imports are hardlinks rather than copies" 
  caption="Figure 4: downloads and the media library sit under one mounted filesystem, mapped identically across every container, so imports are hardlinks rather than copies"
  width="80%"
/>
