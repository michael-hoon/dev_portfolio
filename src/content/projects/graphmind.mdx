...
title: GraphMind
date: 12-21-2024
description: GraphMind is an advanced AI research assistant, leveraging Graph Databases and Multi-agent Collaboration.
image: ../assets/graphmind/graphmind_logo.jpg
info:
  - text: GitHub
    link: https://github.com/michael-hoon/graphreader-agent
    icon:
      type: lucide
      name: github
---
...
import Architecture from '../assets/graphmind/Architecture.jpg';
import Router from '../assets/graphmind/router.jpg';
import ResearchSubgraph from '../assets/graphmind/research_subgraph.jpg';
import AgentNodes from '../assets/graphmind/agent_nodes.png';
import Neo4jOntology from '../assets/graphmind/neo4j_ontology.png';
import StreamlitDemo from '../assets/graphmind/graphmind-streamlit.png';
import Neo4jExample from '../assets/graphmind/neo4j-example.png';
...
<div class="image-row">
    <Image src={Architecture} alt="GraphMind Proposed Architecture" loading="lazy" decoding="async" sizes="(max-width: 1200px) 100vw, 1200px" />
    <Image src={Router} alt="Semantic Router Agent" loading="lazy" decoding="async" sizes="(max-width: 1200px) 100vw, 1200px" />
    <Image src={ResearchSubgraph} alt="Research Subgraph" loading="lazy" decoding="async" sizes="(max-width: 1200px) 100vw, 1200px" />
    <Image src={AgentNodes} alt="Agent Node Architecture" loading="lazy" decoding="async" sizes="(max-width: 1200px) 100vw, 1200px" />
</div>

The Neo4j Knowledge Graph ontology is pre-defined and shown as follows:

<div class="image-center">
    <Image src={Neo4jOntology} alt="Neo4j Ontology" loading="lazy" decoding="async" sizes="(max-width: 1200px) 100vw, 1200px" />
</div>
...
<div class="image-row">
    <Image src={StreamlitDemo} alt="Streamlit Demo" loading="lazy" decoding="async" sizes="(max-width: 1200px) 100vw, 1200px" />
    <Image src={Neo4jExample} alt="Neo4j Example" loading="lazy" decoding="async" sizes="(max-width: 1200px) 100vw, 1200px" />
</div>
